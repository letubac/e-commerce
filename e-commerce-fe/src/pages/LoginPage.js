...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // After successful login, get user info and redirect based on role
      setTimeout(() => {
        // Get fresh user data from localStorage (updated by login function)
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {!twoFactorRequired ? (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="pl-10 pr-12 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-center tracking-widest"
                placeholder="000000"
                maxLength="6"
              />
          ...
          <div>
            ...
            >
              {loading ? 'Đang xử lý...' : twoFactorRequired ? 'Xác thực' : 'Đăng nhập'}
            </button>
          </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gray-100 text-gray-500">Hoặc đăng nhập với</span>
            </div>
          </div>
