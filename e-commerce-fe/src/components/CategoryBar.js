      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex items-center">
          ...
          <div 
            ...
            className="flex items-center space-x-2 py-4 overflow-x-auto scrollbar-hide"
            style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
          >
            {/* All Products */}
            <button
              onClick={() => onCategorySelect(null)}
              className={`flex-shrink-0 flex flex-col items-center justify-center p-3 rounded-lg transition-all duration-200 min-w-[90px] ${
                !selectedCategory 
            ...
            >
              <div className={`w-12 h-12 flex items-center justify-center rounded-full mb-2 ${
                ...
                <Package size={24} className={!selectedCategory ? 'text-white' : 'text-gray-600'} />
              </div>
