...
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'macbook-pro-14-m3-pro-512gb')), -- Admin muốn MacBook Pro
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'ipad-pro-129-m2-512gb')), -- Admin muốn iPad Pro  
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'iphone-15-pro-max-256gb')), -- Admin muốn iPhone 15 Pro Max
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'rtx-4080-super-fe')), -- Admin muốn RTX 4080 SUPER
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'samsung-galaxy-s24-ultra-512gb')), -- Admin muốn Galaxy S24 Ultra
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'asus-rog-strix-g16-rtx4070')), -- Admin muốn ASUS Gaming laptop
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'logitech-g-pro-x-superlight-2')), -- Admin muốn gaming mouse
((SELECT id FROM users WHERE email = 'admin@ecommerce.com' LIMIT 1), (SELECT id FROM products WHERE slug = 'razer-blackwidow-v4-pro')) -- Admin muốn gaming keyboard
...
-- Insert sample addresses (commented out due to user ID dependencies)
 ...
 (7, 'Nguyễn Văn An', '0987654321', '123 Nguyễn Huệ', 'Phường Bến Nghé', 'TP.HCM', 'TP.HCM', '700000', 'Vietnam', TRUE, 'BOTH'),
 (8, 'Trần Thị Bình', '0976543210', '456 Hoàng Hoa Thám', 'Phường 12, Quận Tân Bình', 'TP.HCM', 'TP.HCM', '700000', 'Vietnam', TRUE, 'SHIPPING'),
 (9, 'Lê Hoàng Cường', '0965432109', '789 Lê Lợi', 'Phường 1, Quận 1', 'TP.HCM', 'TP.HCM', '700000', 'Vietnam', TRUE, 'BOTH'),
 (10, 'Phạm Thu Dung', '0954321098', '321 Nguyễn Trãi', 'Phường 2, Quận 5', 'TP.HCM', 'TP.HCM', '700000', 'Vietnam', TRUE, 'SHIPPING');
...
('ORD-2024-000001', 7, 33990000, 3399000, 0, 37389000, 'DELIVERED', 1, 1),
('ORD-2024-000002', 8, 8990000, 899000, 30000, 9919000, 'SHIPPED', 2, 2),
('ORD-2024-000003', 9, 5490000, 549000, 35000, 6074000, 'PROCESSING', 3, 3),
('ORD-2024-000004', 10, 3490000, 349000, 30000, 3869000, 'CONFIRMED', 4, 4),
('ORD-2024-000005', 7, 31990000, 3199000, 0, 35189000, 'PENDING', 1, 1);

-- Insert order items
INSERT INTO order_items (order_id, product_id, product_name, product_sku, price, quantity, total, variant_id) VALUES
(7, (SELECT id FROM products WHERE slug = 'iphone-15-pro-max-256gb'), 'iPhone 15 Pro Max 256GB', 'IPHONE15PM-256-NAT', 33990000, 1, 33990000, 1),
(8, (SELECT id FROM products WHERE slug = 'sony-wh-1000xm5-wireless'), 'Sony WH-1000XM5 Wireless', 'SONY-WH1000XM5-BK', 8990000, 1, 8990000, 12),
(9, (SELECT id FROM products WHERE slug = 'razer-blackwidow-v4-pro'), 'Razer BlackWidow V4 Pro', 'RBW-V4P-GR', 5490000, 1, 5490000, NULL),
(10, (SELECT id FROM products WHERE slug = 'logitech-g-pro-x-superlight-2'), 'Logitech G Pro X Superlight 2', 'LGPXSL2-BK', 3490000, 1, 3490000, 8),
(7, (SELECT id FROM products WHERE slug = 'samsung-galaxy-s24-ultra-512gb'), 'Samsung Galaxy S24 Ultra 512GB', 'SAMS24U-512-BK', 31990000, 1, 31990000, 5);

-- Insert payments
INSERT INTO payments (order_id, amount, method, status, transaction_id, paid_at) VALUES
(7, 37389000, 'CREDIT_CARD', 'COMPLETED', 'TXN-2024-001', NOW() - INTERVAL '5 days'),
(8, 9919000, 'STRIPE', 'COMPLETED', 'TXN-2024-002', NOW() - INTERVAL '3 days'),
(9, 6074000, 'VNPAY', 'PENDING', 'TXN-2024-003', NULL),
(10, 3869000, 'CASH_ON_DELIVERY', 'PENDING', NULL, NULL),
(7, 35189000, 'CREDIT_CARD', 'PROCESSING', 'TXN-2024-005', NULL);

-- Insert search history
INSERT INTO search_history (user_id, search_term, result_count, filters_applied, clicked_product_id) VALUES
(7, 'iPhone 15', 3, '{"category": "dien-thoai", "brand": "apple"}', 1),
(7, 'MacBook Pro', 2, '{"category": "laptop", "price_range": "50000000-60000000"}', 4),
(8, 'Samsung Galaxy', 4, '{"category": "dien-thoai"}', 2),
(8, 'gaming laptop', 5, '{"category": "laptop", "brand": "asus"}', 6),
(9, 'chuột gaming', 8, '{"category": "gaming"}', 8),
(9, 'tai nghe bluetooth', 6, '{"category": "phu-kien-dien-tu"}', 11),
(10, 'RTX 4080', 2, '{"category": "pc-components"}', 10),
...
(7, 1), -- Compare iPhone 15 Pro Max
(7, 2), -- with Galaxy S24 Ultra
(8, 4), -- Compare MacBook Pro
(8, 5), -- with Dell XPS 13
(9, 8), -- Compare gaming mice
(9, 9); -- and keyboards

-- Insert Q&A
INSERT INTO product_questions (product_id, user_id, question, is_answered, is_approved) VALUES
(1, 8, 'iPhone 15 Pro Max có hỗ trợ sạc không dây không?', TRUE, TRUE),
(1, 9, 'Pin iPhone 15 Pro Max sử dụng được bao lâu?', TRUE, TRUE),
(2, 7, 'Galaxy S24 Ultra có kháng nước không?', TRUE, TRUE),
(4, 10, 'MacBook Pro M3 Pro có chạy được game không?', TRUE, TRUE),
(8, 8, 'Chuột này có tương thích với Mac không?', TRUE, TRUE);
...
(7, 'Đơn hàng đã được giao', 'Đơn hàng #ORD-2024-000001 đã được giao thành công', 'ORDER', '/orders/ORD-2024-000001'),
(8, 'Đơn hàng đang vận chuyển', 'Đơn hàng #ORD-2024-000002 đang trên đường giao đến bạn', 'ORDER', '/orders/ORD-2024-000002'),
(7, 'Flash Sale đặc biệt', 'Flash Sale cuối tuần với giảm giá lên đến 50%', 'PROMOTION', '/flash-sale'),
(9, 'Sản phẩm yêu thích giảm giá', 'Razer BlackWidow V4 Pro đang có ưu đãi đặc biệt', 'PRODUCT', '/product/razer-blackwidow-v4-pro'),
(10, 'Chào mừng bạn đến E-SHOP', 'Cảm ơn bạn đã đăng ký tài khoản tại E-SHOP', 'SYSTEM', '/profile');
