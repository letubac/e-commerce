...
public class BusinessApiError {
    ...
    private BusinessApiError() {
        timestamp = new Date();
    }

    public BusinessApiError(HttpStatus status) {
        this();
        this.status = status;
    }

    BusinessApiError(HttpStatus status, Throwable ex) {
        this();
        this.status = status;
    ...
    BusinessApiError(HttpStatus status, String message, Throwable ex) {
        this();
        this.status = status;
