...
ALTER TABLE users add column if not exists role VARCHAR(20) NULL;
ALTER TABLE products add column if not exists image_url VARCHAR(20) NULL;
ALTER TABLE products add column if not exists brand_name VARCHAR(20) NULL;
ALTER TABLE products add column if not exists category_name VARCHAR(20) NULL;